...
export function Dashboard({ instanceName }: DashboardProps) {
  ...
  const handleSubmit = useCallback(
    ...
    [modal, fetchInventory, appendActivity, apiKey],
  );
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 rounded-full bg-slate-800/80 px-3 py-1 text-xs font-medium text-slate-200 ring-1 ring-inset ring-slate-700 hover:bg-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400"
            >
      ...
      {apiKeyLoaded && !apiKey ? (
        <div className="mt-6 rounded-md bg-amber-500/10 px-4 py-3 ring-1 ring-inset ring-amber-500/30">
          ...
          <p className="mt-1 text-xs text-amber-300/80">
            ...
            save it as the active client key. The dashboard will start loading
